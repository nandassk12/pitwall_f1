...
export default function AdvancedTelemetryCharts({ drivers = [], activeDriver = '' }) {
  ...
  const [selectedChart, setSelectedChart] = useState('tyres');
  ...
  const renderSkeleton = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%', height: '220px', padding: '10px' }}>
      <div style={{ width: '40%', height: '14px', backgroundColor: 'var(--border-color)', borderRadius: '3px' }} className="skeleton-pulse" />
      <div style={{ flexGrow: 1, backgroundColor: 'var(--bg-tertiary)', borderRadius: '4px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '15px', gap: '10px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', height: '100%' }}>
          <div style={{ width: '8%', height: '30%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '60%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '45%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '80%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '50%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '90%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
          <div style={{ width: '8%', height: '35%', backgroundColor: 'var(--border-color)', borderRadius: '2px' }} />
        </div>
      </div>
      <style>{`
        @keyframes pulse {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 3fr', gap: '15px' }}>
          ...
          {CHART_TYPES.map(chart => (
            <button
              ...
              style={{
                ...
                fontFamily: 'monospace',
                fontWeight: 'bold',
                backgroundColor: selectedChart === chart.id ? 'var(--border-color)' : '#0c0c12',
        ...
        {/* Chart Canvas */}
        <div style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: '4px', padding: '10px', overflow: 'hidden' }}>
